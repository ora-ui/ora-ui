...
const textareaVariants = cva(
  'w-full min-h-16 rounded-md px-3 py-3 text-base text-foreground transition-colors outline-none placeholder:text-foreground-subtle focus-visible:ring-[3px] focus-visible:ring-focus/50 disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-[3px] aria-invalid:ring-destructive/20 md:text-sm dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40',
  {
    variants: {
      variant: {
        subtle: 'border border-line-ui bg-background-ui/50 focus-visible:border-focus',
